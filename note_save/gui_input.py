...
from .configuration import PRIMARY_BACKGROUND_COLOR, SECONDARY_BACKGROUND_COLOR, DEFAULT_PADDING,\
    TEXT_COLOR, TEXT_LINE_HEIGHT, MAX_PREVIEW_IMAGE_SIZE
...
class InputFrame(Frame):
    ...
    def __init__(self, window, app):
        ...
        self.textbox.pack(fill=tk.X, expand=True, side=tk.LEFT,
    ...
    def image_update(self):
        ...
        for image in self.images:
            self.image_cache.append(ImageFrame(
                self.image_container, image, self.delete_image))
